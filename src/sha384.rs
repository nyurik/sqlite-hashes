...
/// # use sqlite_hashes::register_sha384_function;
/// # fn main() -> Result<()> {
/// let db = Connection::open_in_memory()?;
/// register_sha384_function(&db)?;
...
/// # }
/// ```
pub fn register_sha384_function(conn: &Connection) -> Result<()> {
    crate::core::create_hash_fn::<Sha384>(conn, "sha384")
}
